...
type Collection interface {
	...
	FindOneWithOpt(ctx context.Context, filter interface{}, opts ...*options.FindOneOptions) SingleResult
	...
	DeleteOneSoft(ctx context.Context, filter interface{}) (int64, error)
...
func (md *mongoCollection) DeleteOneSoft(ctx context.Context, filter interface{}) (int64, error) {
	col := md.coll
	update := bson.M{}
	update["$set"] = bson.M{
		"deleted_at": time.Now(),
...
func (mc *mongoCollection) FindOneWithOpt(ctx context.Context, filter interface{}, opts ...*options.FindOneOptions) SingleResult {
